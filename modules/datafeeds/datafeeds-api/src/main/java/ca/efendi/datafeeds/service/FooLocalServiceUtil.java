 ...
 * {@link ca.efendi.datafeeds.service.impl.FooLocalServiceImpl} and is the
 ...
 * @see FooLocalService
 * @see ca.efendi.datafeeds.service.base.FooLocalServiceBaseImpl
 * @see ca.efendi.datafeeds.service.impl.FooLocalServiceImpl
 * @generated
 */
@ProviderType
public class FooLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link ca.efendi.datafeeds.service.impl.FooLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static ca.efendi.datafeeds.model.Foo addFoo(
		ca.efendi.datafeeds.model.Foo foo) {
	...
	* @return the new foo
	*/
	public static ca.efendi.datafeeds.model.Foo createFoo(long fooId) {
	...
	*/
	public static ca.efendi.datafeeds.model.Foo deleteFoo(
		ca.efendi.datafeeds.model.Foo foo) {
	...
	*/
	public static ca.efendi.datafeeds.model.Foo deleteFoo(long fooId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().deleteFoo(fooId);
	}

	public static ca.efendi.datafeeds.model.Foo fetchFoo(long fooId) {
	...
	*/
	public static ca.efendi.datafeeds.model.Foo fetchFooByUuidAndGroupId(
	...
	* @throws PortalException if a foo with the primary key could not be found
	*/
	public static ca.efendi.datafeeds.model.Foo getFoo(long fooId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static ca.efendi.datafeeds.model.Foo getFooByUuidAndGroupId(
		java.lang.String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static ca.efendi.datafeeds.model.Foo updateFoo(
		ca.efendi.datafeeds.model.Foo foo) {
	...
	*/
	public static java.util.List<ca.efendi.datafeeds.model.Foo> getFoos(
		int start, int end) {
	...
	*/
	public static java.util.List<ca.efendi.datafeeds.model.Foo> getFoosByUuidAndCompanyId(
	...
	*/
	public static java.util.List<ca.efendi.datafeeds.model.Foo> getFoosByUuidAndCompanyId(
		...
		com.liferay.portal.kernel.util.OrderByComparator<ca.efendi.datafeeds.model.Foo> orderByComparator) {
		return getService()
