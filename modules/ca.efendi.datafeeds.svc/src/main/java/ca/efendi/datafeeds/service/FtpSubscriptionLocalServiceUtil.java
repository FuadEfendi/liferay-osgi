...
public class FtpSubscriptionLocalServiceUtil {
	...
	*/
	public static FtpSubscription addFtpSubscription(
	...
	*/
	public static FtpSubscription createFtpSubscription(
	...
	*/
	public static FtpSubscription deleteFtpSubscription(
		FtpSubscription ftpSubscription) {
	...
	*/
	...
	public static FtpSubscription fetchFtpSubscription(
		long ftpSubscriptionId) {
	...
	* @throws PortalException if a ftp subscription with the primary key could not be found
	*/
	public static FtpSubscription getFtpSubscription(
		long ftpSubscriptionId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static FtpSubscription updateFtpSubscription(
		FtpSubscription ftpSubscription) {
	...
	*/
	...
	public static java.util.List<FtpSubscription> getAllFtpSubscriptions() {
	...
	*/
	public static java.util.List<FtpSubscription> getFtpSubscriptions(
		int start, int end) {
