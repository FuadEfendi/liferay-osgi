...
public class CJProductLocalServiceUtil {
	...
	*/
	public static CJProduct addCJProduct(
		CJProduct cjProduct) {
	...
	*/
	public static CJProduct createCJProduct(
		long productId) {
	...
	*/
	public static CJProduct deleteCJProduct(
		CJProduct cjProduct) {
	...
	*/
	...
	public static CJProduct fetchCJProduct(
		long productId) {
	...
	*/
	public static CJProduct fetchCJProductByUuidAndGroupId(
		java.lang.String uuid, long groupId) {
		return getService().fetchCJProductByUuidAndGroupId(uuid, groupId);
	}

	public static CJProduct getCJProduct(
	...
	*/
	public static CJProduct getCJProductByUuidAndGroupId(
		java.lang.String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getCJProductByUuidAndGroupId(uuid, groupId);
	}

	public static CJProduct refresh(long userId,
                                    CJProduct newCJProduct)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static CJProduct updateCJProduct(
		CJProduct cjProduct) {
	...
	*/
	public static java.util.List<CJProduct> getCJProducts(
		int start, int end) {
	...
	*/
	public static java.util.List<CJProduct> getCJProductsByUuidAndCompanyId(
