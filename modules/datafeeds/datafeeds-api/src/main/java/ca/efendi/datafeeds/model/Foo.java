 ...
 * @see FooModel
 * @see ca.efendi.datafeeds.model.impl.FooImpl
 * @see ca.efendi.datafeeds.model.impl.FooModelImpl
 * @generated
 */
@ImplementationClassName("ca.efendi.datafeeds.model.impl.FooImpl")
@ProviderType
public interface Foo extends FooModel, PersistedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to {@link ca.efendi.datafeeds.model.impl.FooImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
