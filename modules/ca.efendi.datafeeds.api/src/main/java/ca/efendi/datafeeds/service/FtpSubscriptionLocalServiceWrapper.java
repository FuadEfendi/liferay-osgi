...
public class FtpSubscriptionLocalServiceWrapper
	...
	*/
	@Override
	public ca.efendi.datafeeds.model.FtpSubscription createFtpSubscription(
	...
	*/
	@Override
	public ca.efendi.datafeeds.model.FtpSubscription deleteFtpSubscription(
		ca.efendi.datafeeds.model.FtpSubscription ftpSubscription) {
	...
	*/
	...
	@Override
	public ca.efendi.datafeeds.model.FtpSubscription fetchFtpSubscription(
		long ftpSubscriptionId) {
	...
	*/
	@Override
	public ca.efendi.datafeeds.model.FtpSubscription getFtpSubscription(
		long ftpSubscriptionId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	@Override
	public ca.efendi.datafeeds.model.FtpSubscription updateFtpSubscription(
		ca.efendi.datafeeds.model.FtpSubscription ftpSubscription) {
	...
	*/
	@Override
	public java.util.List<ca.efendi.datafeeds.model.FtpSubscription> getFtpSubscriptions(
		int start, int end) {
