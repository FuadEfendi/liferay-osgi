...
public class FooWrapper implements Foo, ModelWrapper<Foo> {
	...
	*/
	...
	@Override
	public ca.efendi.datafeeds.model.Foo toEscapedModel() {
		return new FooWrapper(_foo.toEscapedModel());
	}

	@Override
	public ca.efendi.datafeeds.model.Foo toUnescapedModel() {
	...
	@Override
	public com.liferay.portal.kernel.model.CacheModel<ca.efendi.datafeeds.model.Foo> toCacheModel() {
		return _foo.toCacheModel();
	}

	@Override
	public int compareTo(ca.efendi.datafeeds.model.Foo foo) {
