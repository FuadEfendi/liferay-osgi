create index IX_3F216A9A on FE_CJProduct (companyId);
create unique index IX_CB8C59F1 on FE_CJProduct (groupId, sku[$COLUMN_LENGTH:77$]);
create index IX_9DC089D3 on FE_CJProduct (manufacturer[$COLUMN_LENGTH:75$]);
create unique index IX_21BC426A on FE_CJProduct (programName[$COLUMN_LENGTH:75$], catalogName[$COLUMN_LENGTH:75$], sku[$COLUMN_LENGTH:77$]);
